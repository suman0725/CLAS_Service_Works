...
# File paths
eff_file = "/w/hallb-scshelf2102/clas12/suman/SW_25/efficiency/efficiency_s2_l5.txt"
voltage_file = "/w/hallb-scshelf2102/clas12/suman/SW_25/stripVoltages/B_DET_BMT_HV_SEC2_L5_STRIP.txt"
output_file = "/w/hallb-scshelf2102/clas12/suman/SW_25/test/comparison_s2_l5.txt"
...
with open(output_file, "w") as f:
    f.write("Tile S2 L5 (Efficiency < 0.9):\n")
...
plt.title("Efficiency and Voltage vs Run Number for S2 L5 (Efficiency < 0.9)", pad=15)
fig.tight_layout()
fig.legend(loc="upper center", bbox_to_anchor=(0.5, -0.05), ncol=3, fontsize=10)
plt.savefig("/w/hallb-scshelf2102/clas12/suman/SW_25/test/s2_l5_plot.png", dpi=300)
plt.close()